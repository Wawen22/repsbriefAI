...
- [ ] **Phase 6: Revenue Launch & Paid Beta** (In corso)
  ...
  - [x] Worktree `feat-apify-trend-resilience`: Task 2 — schema persistente non applicato e repository trend
...
| **feat-apify-trend-resilience** | 🟡 **Task 2 completato** | Senior Full-Stack / 🟡 P1 | Contratti, feature flag, migration locale non applicata e repository; Reddit/Google Trends restano disabilitate, nessun Actor o migration applicata. |
