...
export default async function MyIdeasPage() {
  ...
  const stats = (allIdeas || []).reduce((acc: any, curr: any) => {
    acc[curr.status || 'backlog'] = (acc[curr.status || 'backlog'] || 0) + 1
    return acc
  }, {})
  ...
  return (
    <div className="space-y-10">
      ...
      <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-0.5">
               ...
               <p className="text-[10px] font-medium text-slate-500 uppercase tracking-widest">Execute your content strategy</p>
            </div>
          </div>
        ...
        {hasIdeas && (
          <div className="flex flex-wrap items-center gap-2">
             <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-slate-400 text-[10px] font-bold uppercase tracking-widest">
      ...
      {!hasIdeas ? (
        <div className="relative py-32 flex flex-col items-center justify-center text-center overflow-hidden rounded-[3rem] border border-white/5 bg-white/[0.02] shadow-2xl">
          ...
          <div className="relative z-10 space-y-8 max-w-lg">
            ...
            <div className="space-y-3">
              <h2 className="text-3xl font-bold text-white tracking-tight">Your Board is Empty</h2>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <KanbanBoard initialIdeas={allIdeas as any} />
        </div>
      )}
    </div>
  )
