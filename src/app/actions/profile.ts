...
Your goal is to analyze a set of writing samples from a creator and extract their unique "Brand Voice Profile".`
...
`
  ...
  try {
    ...
    return { error: 'Failed to analyze brand voice.' }
  }
}
