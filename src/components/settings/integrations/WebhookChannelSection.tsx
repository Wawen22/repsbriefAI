...
const CHANNEL_STYLES: Record<WebhookChannel, ChannelStyle> = {
  generic: {
    rootClass:
      'border-orange-500/20 bg-orange-500/5 p-6 md:p-8 space-y-6',
  ...
  slack: {
    rootClass:
      'border-cyan-500/20 bg-cyan-500/5 p-6 md:p-8 space-y-6',
    ...
    inputUrlLabel: 'URL webhook in entrata Slack',
    inputUrlPlaceholder: 'https://hooks.slack.com/services/...',
    emptyText: 'Nessun canale Slack configurato.',
    defaultName: 'Notifiche Slack',
    closeLabel: 'Chiudi',
  },
  discord: {
    rootClass:
      'border-indigo-500/20 bg-indigo-500/5 p-6 md:p-8 space-y-6',
  ...
  return (
    ...
    >
      <div className="min-h-0 overflow-hidden pb-2">
        <Card className={`${style.rootClass} transition-all duration-300 ease-out`}>
          ...
          <div className="grid gap-4 md:grid-cols-7 items-end p-6 rounded-2xl bg-white/[0.02] border border-white/5">
            ...
            <div className="md:col-span-1">
              <Button
                ...
                disabled={canManageIntegrations === false}
                aria-label="Aggiungi webhook"
                title="Aggiungi webhook"
              >
